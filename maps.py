...
# url = "https://api.geoapify.com/v2/places?categories=catering.restaurant.italian&filter=circle:-75.665214,45.40205,8000&bias=proximity:-75.665214,45.40205&limit=5&apiKey=daca2f31ca5b4f6a8fb56dea4b85f26d"
...
#     address = (i['properties']['formatted'])
#     place_id = (i['properties']['place_id'])
#     url = "https://api.geoapify.com/v2/place-details?id="+place_id+"&features=details,radius_500,radius_500.restaurant&apiKey=daca2f31ca5b4f6a8fb56dea4b85f26d"
#     headers = CaseInsensitiveDict()
#     headers["Accept"] = "application/json"
#     # print(restaurant)
...
#     else:
#         phone = "+1-613-461-6787"
#     rest.append([restaurant, street, distance, address, phone])
# print(rest[1])
